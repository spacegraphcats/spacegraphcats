...
def main(argv):
    ...
    with open(args.output, 'wt') as fp:
        w = csv.writer(fp)
        w.writerow(["filename", "record_name", "catlas_base", "cdbg_file", "prospective_reads_file", "total_kmers", "mean_abund"])
        ...
        for (filename, record_name), cdbg_ids in records_to_cdbg.items():
            ...
            w.writerow([filename, record_name, catlas_base, cdbg_file, reads_file, total_kmers, average_abund])
